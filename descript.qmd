...
@cle94ele and @cle84graa are the best sources of how-to
...
Also see Saloni Dattani's [excellenet article on data visualization]{https://www.scientificdiscovery.dev/p/salonis-guide-to-data-visualization).
...
#| fig-width: 6
#| fig-height: 5
knitr::include_graphics('images/desc-proportions-txreg.png')
```
...
#| fig-width: 5.5
#| fig-height: 7
knitr::include_graphics('images/aevents.png')
```
...
symbol is stratified into 15 groups of approximately equal numbers of
points. 
...
#| fig-width: 8
knitr::include_graphics('images/cchem-byx-cont-a.png')
```
...
knitr::include_graphics('images/image.sepsis.png')
```
...
knitr::include_graphics('images/image.stroke.png')
```
