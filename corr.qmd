...
```{r w=4.5,h=3.75}
#| label: fig-corr-direction
#| fig-cap: "Sample size required to ensure a high probability of the sample correlation coefficient being in the right direction"
...
```{r w=4.5,h=3.75}
#| label: fig-corr-ndirection
#| fig-cap: "Probability of having the correct sign on $r$ as a function of $n$ and true correlation $\\rho$"
...
The following example using "super smoother" of @fri84var in place of _loess_ to estimate a complex relationship that has a sharp turn.
