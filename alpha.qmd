...
`r quoteit("Asking one to compute type I assertion probability α for a Bayesian design is like asking a poker player winning $10M/year to justify his ranking by how often he places bets in games he didn't win.")`
...
`r quoteit('The probability of being wrong in asserting an effect depends on the amount of evidence for the effect, just just on whether the amount of evidence exceeds some threshold.')`
...
`r quoteit("Do you want the probability of a positive result **when** there is nothing?  Or the probability that a positive result **turns out to be** nothing?")`
...
`r quoteit("You cannot call something an error by assuming the very fact that would make it one.")`
...
<img src="images/raf.png" width="100%">
<br>
...
Technical details, more examples, and references concerning what is covered in this chapter may be found [here](https://hbiostat.org/proj/covid19/statdesign.html), [here](https://hbiostat.org/bayes/bet/evidence.html), and [here](https://hbiostat.org/doc/bayes/whybayes.pdf).
