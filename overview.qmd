  ...
  optimize decisions
    + Not directly actionable: probabilities that condition on the
     ...
     the unknown
       ...
       - sensitivity and specificity ($P(\textrm{test result} |
       \textrm{disease status})$)<br>
...
* See @sec-changegen and @sec-ancova
...
* _Probability_ traditionally taken as long-run relative frequency
