...
* Good for proof of concept of a diagnostic method in a case--control study; not useful for utility [See [here](https://stats.stackexchange.com/questions/328550) for a discussion of how sensitivity and specificity change with prevalence.]{.aside}
...
knitr::include_graphics('images/hla09criFig3.png')
```
...
<img src="images/ordinal-calibrate-1.png" width="70%">
