...
function finds datasets in <https://hbiostat.org/data>, downloads them, and `load()`s them in your `R` session.
...
Concerning analysis scripts, some complete analysis script tamplates have been collected
on
[github.com/harrelfe/rscripts](https://github.com/harrelfe/rscripts)\footnote{`github` has
  ...
  are most welcomed.  Contact <tt>fh@fharrell.com</tt> if you
...
1. Install `Quarto` from [quarto.org](https://quarto.org/docs/get-started) if you don't want to use the version of `Quarto` that is provided automatically with `RStudio`
...
<img src="images/rstudioOptions.png" width="50%"><img src="rstudioSweave.png" width="50%">
-->
...
getRs('introda.r', put='rstudio')  # download introda.r and open in script editor
