...
* Setup for advanced features, including code pretty-printing, shown at [biostat.app.vumc.org/KnitrHowto](http://biostat.app.vumc.org/KnitrHowto)
* Simplified implementation of caching

See [R Workflow](https://hbiostat.org/rflow) for much more detail.
